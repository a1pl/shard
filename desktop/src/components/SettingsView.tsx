...
export function SettingsView() {
  ...
  // OS info state
  const [osInfo, setOsInfo] = useState<{ platform: string; arch: string; version: string } | null>(null);
          ...
          <>
              ...
              <section className="settings-card" style={{ marginBottom: 24 }}>
                ...
                <div className="about-system-info">
                  <div className="about-system-row">
                    <span className="about-system-label">Platform</span>
                    <span className="about-system-value" style={{ textTransform: "capitalize" }}>{osInfo.platform}</span>
                  </div>
                  <div className="about-system-row">
                    <span className="about-system-label">Architecture</span>
                    <span className="about-system-value">{osInfo.arch}</span>
                  </div>
                  <div className="about-system-row">
                    <span className="about-system-label">OS Version</span>
                    <span className="about-system-value">{osInfo.version}</span>
                  </div>
                </div>
              </section>
            )}
            ...
            <section className="settings-card" style={{ marginBottom: 24 }}>
              ...
              <div className="about-links">
                <button className="btn btn-ghost" style={{ justifyContent: "flex-start", width: "100%" }} onClick={() => openUrl("https://github.com/Th0rgal/shard")}>
